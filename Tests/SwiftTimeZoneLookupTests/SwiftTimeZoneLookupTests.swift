...
final class SwiftTimeZoneLookupTests: XCTestCase {
    func testLookup() throws {
        ...
        XCTAssertEqual(database.simple(latitude: 36.5362, longitude: 26.3396), "Europe/Athens")
        XCTAssertEqual(database.simple(latitude: 36.8370, longitude: 25.8904), "Europe/Athens")
        XCTAssertEqual(database.simple(latitude: 36.3683, longitude: 25.7735), "Europe/Athens")
        ...
        XCTAssertEqual(database.simple(latitude: 10.12, longitude: -64.70), "America/Caracas")
        XCTAssertEqual(database.simple(latitude: 12.13, longitude: -68.28), "America/Kralendijk")
        XCTAssertEqual(database.simple(latitude: 10.61, longitude: -66.98), "America/Caracas")
        XCTAssertEqual(database.simple(latitude: 6.73, longitude: -66.98), "America/Caracas")
        XCTAssertEqual(database.simple(latitude: 12.05, longitude: -61.73), "America/Grenada")
        XCTAssertEqual(database.simple(latitude: 10.97, longitude: -63.83), "America/Caracas")
        XCTAssertEqual(database.simple(latitude: 10.65, longitude: -61.52), "America/Port_of_Spain")
        XCTAssertEqual(database.simple(latitude: 7.58, longitude: -72.07), "America/Caracas")
        XCTAssertEqual(database.simple(latitude: 11.15, longitude: -60.84), "America/Port_of_Spain")
        XCTAssertEqual(database.simple(latitude: 10.15, longitude: -68.03), "America/Caracas")
        XCTAssertEqual(database.simple(latitude: 9.00525, longitude: -62.64493), "America/Caracas")
    }
}
